 ...
 * 
 * core-idea:
 * "Use DFS to calculate the sum for each root-to-leaf path by accumulating the current number and adding it when a leaf is reached."
 * 
 * observations:
 ...
 * pattern-recognition:
 * why-this-pattern:
 * "DFS is ideal for traversing all possible paths from root to leaf in a tree structure."
 * 
 * alternative-approaches:
 * - "Iterative DFS using a stack."
 * 
 * why-not-alternatives:
 * "The recursive approach is cleaner and simpler for this problem size and constraints."
 * 
 * window-details:
 * window-type: ""
 * expand-condition: ""
 ...
 * 
 * dry-run-example:
 * "Traverse tree [4,9,0,5,1]: Path sums 495, 491, 40 give total 1026."
 * 
 * complexity:
 * time: "O(n)"
 * space: "O(h)"
 ...
 * confidence: "High"
 * difficulty-reason:
 * "Understanding path accumulation correctly with digit manipulation."
 * 
 * learning-outcome:
 ...
 * 
 * solution-summary:
 * "Utilize DFS to traverse each tree path, accumulate root-to-leaf numbers, and sum them for the final result."
 */
