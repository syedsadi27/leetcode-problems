 ...
 * 
 * core-idea:
 * "Use a stack to perform preorder traversal (Node, Left, Right) iteratively."
 * 
 * observations:
 ...
 * pattern-recognition:
 * why-this-pattern:
 * "Iterative DFS using a stack mimics the call stack of recursion efficiently."
 * 
 * alternative-approaches:
 * - "Recursive traversal technique."
 * 
 * why-not-alternatives:
 * "The iterative method is typically preferred for avoiding stack overflow issues and is often more efficient in terms of stack frame usage."
 * 
 * window-details:
 * window-type: "N/A"
 ...
 * 
 * dry-run-example:
 * "Given root = [1,null,2,3], stack helps visit nodes: 1 -> 2 -> 3."
 * 
 * complexity:
 * time: "O(n)"
 * space: "O(n)"
 ...
 * 
 * solution-summary:
 * "Implemented an iterative preorder traversal using DFS with a stack, ensuring correct node visiting order and efficiently handling tree navigation without recursion."
 */
